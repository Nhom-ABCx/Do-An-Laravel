        ...
        <div class="page-content">
            ...
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <div class="pull">
                        <a type="button" class="btn btn-success " href="{{ route('CTKhuyenMai.create') }}"><i
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
                                                ...
                                                <a class="green"
                                                    href="{{ route('CTKhuyenMai.edit', [$item->ChuongTrinhKhuyenMaiId, $item->SanPhamId]) }}">
                                                    <i class="icon-pencil bigger-130"></i>
                                                </a>
                                                <form
                                                    action="{{ route('CTKhuyenMai.destroy', [$item->ChuongTrinhKhuyenMaiId, $item->SanPhamId]) }}"
                                                    method="post">
                                                    @csrf
                                                    @method('DELETE')
