    ...
    <div class="page-content">
        ...
        <div class="row">
            <div class="col-xs-12">
                ...
                <form class="form-horizontal" role="form" action="{{ route('DonViVanChuyen.store') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    {{-- @method('PATCH') --}}
                    <div class="form-group">
                        ...
                        <div class="col-sm-3">
                            <div class="input-group">
                                ...
                                <input class="form-control" type="text" placeholder="Nhập tên đơn vị vận chuyển" value="{{ old('TenDonViVanChuyen') }}" name="TenDonViVanChuyen" />
                            </div>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-3">
                            <div class="input-group">
                                ...
                                <input class="form-control" type="text" placeholder="Nhập website" value="{{ old('Website') }}" name="Website" />
                            </div>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-3">
                            ...
                            <input type="text"  id="spinner3" value="{{ old('Email') }}" name="Email" />
                            </div>
