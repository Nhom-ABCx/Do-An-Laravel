    ...
    <div class="page-content">
        ...
        <div class="row">
            <div class="col-xs-12">
                ...
                <form class="form-horizontal" role="form" action="{{ route('NguoiVanChuyen.store') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    {{-- @method('PATCH') --}}
                    <div class="form-group">
                        ...
                        <div class="col-sm-3">
                            <div class="input-group">
                                ...
                                <input class="form-control" type="text" placeholder="Nhập tên người vận chuyển " value="{{ old('HoTen') }}" name="HoTen" />
                            </div>
                        </div>
                        @if ($errors->has('HoTen'))
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-3">
                            <div class="input-group">
                                ...
                                <input class="form-control" type="date" value="{{ old('NgaySinh') }}" name="NgaySinh" />
                            </div>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-3">
                            <div class="input-group">
                                ...
                                <input type="text" placeholder="Nhập địa chỉ" id="spinner1" value="{{ old('DiaChi') }}" name="DiaChi" />
                            </div>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-3">
                            <div class="input-group">
                                ...
                                {{-- số hiển thị của cái này thì chỉnh ở dưới javascript "spinner1" --}}
                                <input type="text" id="spinner1" value="{{ old('Phone') }}" name="Phone" />
                            </div>
                        </div>
                        @if ($errors->has('Phone'))
                        <i class="icon-remove bigger-110 red"> {{ $errors->first('DiaChi') }}</i>
                        ...
                        <div class="col-sm-3">
                            <div class="input-group">
                                ...
                                <select name="DonViVanChuyenId">
                                    ...
                                    <option value="{{$item->id}}" @if ($item->id == old('DonViVanChuyenId')) selected @endif>
