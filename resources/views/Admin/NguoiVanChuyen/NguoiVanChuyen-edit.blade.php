        ...
        <div class="page-content">
            ...
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <form class="form-horizontal" role="form" action="{{ route('NguoiVanChuyen.update', $nvc) }}"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-3">
                                <div class="input-group">
                                    ...
                                    <input class="form-control" type="date" value={{ $nvc->NgaySinh }}
                                        name="NgaySinh" />
                                </div>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-3">
                                <div class="input-group">
                                    ...
                                    <input type="text" placeholder="Nhập địa chỉ" id="spinner1" value="{{ $nvc->DiaChi }}"
                                        name="DiaChi" />
                                </div>
                            </div>
