    ...
    <div class="main-content">
        ...
        <div class="page-content">
            <div class="span4">
                ...
                <form class="form-horizontal" role="form" action="{{ route('KhuyenMai.update', $ctkm) }}" method="POST"
                                ...
                                <div class="control-group">
                                    <div class="row-fluid input-append">
                                        <textarea id="form-field-11" class="autosize-transition form-control"
                                            name="TenChuongTrinh">{{ $ctkm->TenChuongTrinh }}</textarea>
                                    </div>
                                </div>
                                <hr />
                                    ...
                                    <div class="input-group">
                                        ...
                                        <div class="row-fluid input-prepend">
                                            <input type="date" class="form-control" id="form-input-readonly"
                                                value={{ $ctkm->FromDate }} name="FromDate" />
                                        </div>
                                    </div>
                                </div>
                                <hr />
