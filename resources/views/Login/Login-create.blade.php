                            ...
                            <div id="signup-box" class="signup-box visible widget-box no-border">
                                <div class="widget-body">
                                    <div class="widget-main">
                                        ...
                                        <form action="{{ route('Login.store') }}" method="post">
                                            ...
                                            <fieldset>
                                                ...
                                                @if ($errors->has('Email'))
                                                    <i class="icon-remove bigger-110 red">{{ $errors->first('Email') }}</i>
                                                @endif
                                                ...
                                                <label class="block clearfix">
                                                    <span class="block input-icon input-icon-right">
                                                        <input type="tel" pattern="[0-9]{10}" class="form-control" placeholder="Phone 10 number" value="{{ old('Phone') }}" name="Phone" />
                                                ...
                                                @if ($errors->has('XacNhan_MatKhau'))
                                                    <i class="icon-remove bigger-110 red">{{ $errors->first('XacNhan_MatKhau') }}</i>
                                                @endif
                                    ...
                                    <div class="toolbar center">
                                        <a href="{{ route('Login.index') }}" class="back-to-login-link">
