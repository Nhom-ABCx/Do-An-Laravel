...
class CTChuongTrinhKMController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('Admin.CTKhuyenMai.CTKhuyenMai-index', ['ctctkm' => $data, $ctctkm]);
    }
    ...
    public function create()
    {
        ...
        $sanPham = SanPham::all();
        return view('Admin.CTKhuyenMai.CTKhuyenMai-create', ['ctkm' => $ctKhuyenMai, 'sanPham' => $sanPham]);
    }
    ...
    public function edit($ctId, $spId)
    {
        ...
        //dd($ctctkm);
        return view('Admin.CTKhuyenMai.CTKhuyenMai-edit', ['ctctkm' => $query, 'ctkm' => $ctkm, 'sanPham' => $sanPham]);
    }
