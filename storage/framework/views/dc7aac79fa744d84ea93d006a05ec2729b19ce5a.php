            ...
            <div class="ks-page-content-body">
                <div class="ks-messenger">
                    <div class="ks-discussions">
                        ...
                        <div class="ks-body ks-scrollable jspScrollable" data-auto-height="" style="overflow-y: auto; padding: 0px;" tabindex="0">
                    ...
                    <div class="ks-messages ks-messenger__messages">
                        <div class="ks-header">
                            ...
                            <div class="ks-controls">
                                <div class="dropdown">
                                    <button class="btn btn-primary-outline ks-light ks-no-text ks-no-arrow" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true"
                                        aria-expanded="false">
                                            ...
                                            <?php if(!empty($item->NhanVienId)): ?>
                                                <li class="ks-item ks-from">
                                                    <span class="ks-avatar ks-online">
                                                        <img src="/storage/assets/images/avatar/NhanVien/<?php echo e($item->NhanVien->id); ?>/<?php echo e($item->NhanVien->HinhAnh); ?>" width="36" height="36"
...
<?php echo $__env->make('layouts.Layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\tranphuocvinh\laravel\Do-An-Laravel\resources\views/Message/Message-index.blade.php ENDPATH**/ ?>