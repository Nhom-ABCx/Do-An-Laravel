    ...
    <div class="page-content">
        ...
        <div class="row">
            <div class="col-xs-12">
                ...
                <div class="pull">
                    <a type="button" class="btn btn-success " href="<?php echo e(route('CTKhuyenMai.create')); ?>"><i class="fa fa-plus"></i> Thêm chi tiết chương trình khuyến mãi</a>
                </div>
                </br>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
                                        ...
                                        <a class="green" href="<?php echo e(route('CTKhuyenMai.edit',[$item->ChuongTrinhKhuyenMaiId,$item->SanPhamId])); ?>">
                                            <i class="icon-pencil bigger-130"></i>
                                        </a>
                                        <form action="<?php echo e(route('CTKhuyenMai.destroy',[$item->ChuongTrinhKhuyenMaiId,$item->SanPhamId])); ?>" method="post">
                                            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.Layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\tranphuocvinh\laravel\Do-An-Laravel\resources\views/CTKhuyenMai/CTKhuyenMai-index.blade.php ENDPATH**/ ?>