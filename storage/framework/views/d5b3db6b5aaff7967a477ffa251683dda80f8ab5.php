...
<![endif]-->
    ...
    <script type="text/javascript">
        if ("ontouchend" in document) document.write("<script src='/storage/assets/js/jquery.mobile.custom.min.js'>" + "<" + "/script>");
    </script>
...
<script src="/storage/assets/js/jquery.dataTables.min.js"></script><?php /**PATH D:\Program Files\xampp\htdocs\Do-An-Laravel\resources\views/layouts/Layout.blade.php ENDPATH**/ ?>