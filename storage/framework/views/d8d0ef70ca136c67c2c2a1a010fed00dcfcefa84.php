                                ...
                                <td>
                                    <div class="product_count">
                                        <input type="text" name="qty" id="sst" maxlength="12" value="1" title="Quantity:"
                                            class="input-text qty" spellcheck="false" data-ms-editor="true">
                                        <button
                            ...
                            <tr class="bottom_button">
                                ...
                                <td>
                                    <div class="cupon_text d-flex align-items-center">
                                        <input type="text" placeholder="Coupon Code" spellcheck="false"
                                            data-ms-editor="true">
                            ...
                            <tr class="shipping_area">
                                ...
                                <td>
                                    <div class="shipping_box">
                                        ...
                                        <input type="text" placeholder="Postcode/Zipcode" spellcheck="false"
                                            data-ms-editor="true">
...
<?php echo $__env->make('User.layouts.Layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Program Files\xampp\htdocs\Do-An-Laravel\resources\views/User/GioHang/Cart.blade.php ENDPATH**/ ?>