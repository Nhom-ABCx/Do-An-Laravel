...
<script type="text/javascript">
    function showLoaiSanPham(typeShow, loaiSanPhamId) {
        $.ajax({
            ...
            url: "<?php echo e(route('LoaiSanPham.show', '')); ?>/" + typeShow + "?LoaiSanPhamId=" + loaiSanPhamId,
            //du lieu gui di
            data: {},
...
<?php /**PATH D:\DDDD\Do-An-Laravel\resources\views/Admin/LoaiSanPham/LoaiSanPham-show-script.blade.php ENDPATH**/ ?>