                            ...
                            <div class="widget-main">
                                ...
                                <form class="form-inline" action="<?php echo e(request()->is('Admin/HoaDonNhapp/DaHuy') ? route('HoaDonNhap.DaHuy') : route('HoaDonNhap.index')); ?>" method="get"
                                    ...
                                    <select class="width-10 chosen-select" id="form-field-select-4" name="NhanVienId">
                                        ...
                                        <?php $__currentLoopData = $dsNhanVien; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($item->id); ?>" <?php if($item->id == $request['NhanVienId']): ?> selected <?php endif; ?>>
...
<?php echo $__env->make('Admin.layouts.Layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Program Files\xampp\htdocs\Do-An-Laravel\resources\views/Admin/HoaDon/HoaDonNhap-index.blade.php ENDPATH**/ ?>