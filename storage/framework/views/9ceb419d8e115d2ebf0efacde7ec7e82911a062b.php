                        ...
                        <div class="widget-main">
                            ...
                            <div class="control-group">
                                <div class="row-fluid input-prepend">
                                    ...
                                    <input  type="date" value="<?php echo e($ctkm->FromDate); ?>" name="FromDate"  />
                                </div>
                            </div>
                            <hr />
                            <div class="row-fluid">
                            ...
                            <div class="control-group">
                                <div class="row-fluid input-prepend">
                                    <input  type="date" value="<?php echo e($ctkm->ToDate); ?>" name="ToDate"  />
                                </div>
                            </div>
                            <hr />
...
<?php echo $__env->make('layouts.Layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\tranphuocvinh\laravel\Do-An-Laravel\resources\views/KhuyenMai/KhuyenMai-edit.blade.php ENDPATH**/ ?>