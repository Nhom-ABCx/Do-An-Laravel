    ...
    <div class="page-content">
        ...
        <div class="row">
            <div class="col-xs-12">
                ...
                <form class="form-horizontal" role="form" action="<?php echo e(route('CTKhuyenMai.update',[$ctctkm[0]->ChuongTrinhKhuyenMaiId,$ctctkm[0]->SanPhamId])); ?>" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-3">
                            <div class="input-group">
                                ...
                                <input class="form-control" readonly type="text" id="form-input-readonly" value="<?php echo e($ctkm->TenChuongTrinh); ?>" disabled>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-3">
                            <div class="input-group">
                                ...
                                <input class="form-control" readonly type="text" id="form-input-readonly" value="<?php echo e($sanPham->TenSanPham); ?>" disabled>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                            ...
                            <div class="col-sm-3">
                                <div class="input-group">
                                    ...
                                    <input type="text" value="<?php echo e($ctctkm[0]->GiamGia); ?>" class="input-mini" id="spinner1"  name="GiamGia" />
                                </div>
                            </div>
                        </div>
                    <div class="space-4"></div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-3">
                                ...
                                <input type="text" class="input-mini" id="spinner3" value="<?php echo e($ctctkm[0]->SoLuong); ?>" name="SoLuong" />
                            </div>
                    </div>
                    <div class="space-4"></div>
...
<script type="text/javascript">
    jQuery(function($) {
        ...
        _value_GiamGia=<?php echo e($ctctkm[0]->GiamGia); ?>;
        _value_SoLuong=<?php echo e($ctctkm[0]->SoLuong); ?>;
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.Layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Program Files\xampp\htdocs\Do-An-Laravel\resources\views/CTKhuyenMai/CTKhuyenMai-edit.blade.php ENDPATH**/ ?>