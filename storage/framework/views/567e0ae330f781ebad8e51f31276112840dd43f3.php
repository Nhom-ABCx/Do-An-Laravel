                        ...
                        <div class="widget-main">
                            ...
                            <div class="control-group">
                                <div class="form-group">
                                    ...
                                    <input type="date" name="FromDate"  placeholder="Start Date">
                                </div>
                            </div>
                            <div class="control-group">
                                <div class="form-group">
                                    <label for="input_to">To date</label><br>
                                    <input type="date" name="ToDate"   placeholder="End Date">
                                </div>
                            </div>
                            <hr />
                            <button class="btn btn-primary" type="submit"><i class="fa fa-check-square-o"></i> Thêm</button>
                        </div>
                    </div>
                </div>
            </form>
...
<?php echo $__env->make('layouts.Layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\tranphuocvinh\laravel\Do-An-Laravel\resources\views/KhuyenMai/KhuyenMai-create.blade.php ENDPATH**/ ?>