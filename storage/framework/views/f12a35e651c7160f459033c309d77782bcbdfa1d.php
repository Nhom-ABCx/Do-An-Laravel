...
<div class="main-content">
    ...
    <ul class="breadcrumb">
        ...
        <li class="active">Thêm người vận chuyển</li>
    </ul><!-- .breadcrumb -->
    ...
    <div class="page-content">
        ...
        <div class="row">
            <div class="col-xs-12">
                ...
                <form class="form-horizontal" role="form" action="<?php echo e(route('NguoiVanChuyen.store')); ?>" method="post" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-3">
                            <div class="input-group">
                                ...
                                <input class="form-control" type="text" placeholder="Nhập tên người vận chuyển " value="<?php echo e(old('HoTen')); ?>" name="HoTen" />
                            </div>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-3">
                            <div class="input-group">
                                ...
                                <input class="form-control" type="date" value="<?php echo e(old('NgaySinh')); ?>" name="NgaySinh" />
                            </div>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-3">
                            <div class="custom-control custom-radio custom-control-inline">
                                <input class="custom-control-input" type="radio" value="1"  id="male" name="GioiTinh">
                                <label class="custom-control-label" for="male">Nam</label>
                            </div>
                            <div class="custom-control custom-radio custom-control-inline">
                                <input class="custom-control-input" type="radio" value="0" id="female" name="GioiTinh">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-3">
                            <div class="input-group">
                                ...
                                <input type="text" placeholder="Nhập địa chỉ" id="spinner1" value="<?php echo e(old('DiaChi')); ?>" name="DiaChi" />
                            </div>
                        </div>
                        ...
                        <div class="col-sm-3">
                            <div class="input-group">
                                ...
                                <select name="DonViVanChuyenId">
                                    ...
                                    <option value="<?php echo e($item->id); ?>" <?php if($item->id == old('DonViVanChuyenId')): ?> selected <?php endif; ?>>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.Layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Program Files\xampp\htdocs\Do-An-Laravel\resources\views/NguoiVanChuyen/NguoiVanChuyen-create.blade.php ENDPATH**/ ?>