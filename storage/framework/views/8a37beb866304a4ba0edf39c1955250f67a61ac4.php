            ...
            <div class="main_menu">
                <nav class="navbar navbar-expand-lg navbar-light main_box">
                    <div class="container">
                        ...
                        <a class="navbar-brand logo_h" href="<?php echo e(route('User.home')); ?>"><img
                        ...
                        <div class="collapse navbar-collapse offset" id="navbarSupportedContent">
                            <ul class="nav navbar-nav menu_nav ml-auto">
                                <li class="nav-item active"><a class="nav-link"
                                        href="<?php echo e(route('User.home')); ?>">Trang chủ</a></li>
                                <li class="nav-item"><a class="nav-link" href="index.html">Loại sản phẩm</a>
                                </li>
                                <li class="nav-item"><a class="nav-link" href="contact.html">Liên hệ</a></li>
                            </ul>
                            <ul class="nav navbar-nav navbar-right">
                                <li class="nav-item"><a href="<?php echo e(route('User.GioHang.index')); ?>"
                                ...
                                <li class="nav-item <?php echo e(request()->is('User') ? 'active' : ''); ?>">
                                    ...
                                    <a href="<?php echo e(route('User.KhachHang.index')); ?>" class="user"
...
<?php /**PATH D:\tranphuocvinh\laravel\Do-An-Laravel\resources\views/User/layouts/Layout.blade.php ENDPATH**/ ?>