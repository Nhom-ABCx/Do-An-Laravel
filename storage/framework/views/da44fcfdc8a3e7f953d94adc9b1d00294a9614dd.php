                    ...
                    <div class="widget-box">
                        ...
                        <div class="widget-body">
                            <div class="widget-main">
                                <a href="<?php echo e(route('SanPham.create')); ?>" role="button" class="btn btn-success">
                                    <i class="icon-plus"></i>
                                    Thêm sản phẩm
                                </a>
                                <?php if(URL::current() == route('SanPham.DaXoa')): ?>
...
<?php echo $__env->make('Admin.layouts.Layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\wwww3q\Desktop\Do-An-Laravel\resources\views/Admin/SanPham/SanPham-index.blade.php ENDPATH**/ ?>