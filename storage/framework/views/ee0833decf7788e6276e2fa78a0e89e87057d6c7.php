        ...
        <div class="page-content">
            ...
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <form class="form-horizontal" role="form" action="<?php echo e(route('NguoiVanChuyen.update', $nvc)); ?>"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-3">
                                <div class="input-group">
                                    ...
                                    <input class="form-control" type="text" placeholder="Nhập tên người vận chuyển "
                                        value="<?php echo e($nvc->HoTen); ?>" name="HoTen" />
                                </div>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-3">
                                <div class="input-group">
                                    ...
                                    <input class="form-control" type="date" value=<?php echo e($nvc->NgaySinh); ?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-3">
                                <div class="input-group">
                                    ...
                                    <input type="text" placeholder="Nhập địa chỉ" id="spinner1" value="<?php echo e($nvc->DiaChi); ?>"
                                        name="DiaChi" />
                                </div>
                            </div>
