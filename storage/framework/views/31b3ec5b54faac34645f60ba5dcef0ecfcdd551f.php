                            ...
                            <div id="login-box" class="login-box visible widget-box no-border">
                                <div class="widget-body">
                                    <div class="widget-main">
                                        ...
                                        <form action="<?php echo e(route('Login.show')); ?>" method="post" id="submitForm">
                                            <?php echo csrf_field(); ?>
                                            <fieldset>
                                        ...
                                        <div class="social-login center">
                                            ...
                                            <a class="btn btn-danger" href="<?php echo e(route('Login.social', 'Google')); ?>">
                                                <i class="icon-google-plus"></i>
                                            </a>
                                            <a class="btn btn-dark" href="<?php echo e(route('Login.social', 'Github')); ?>">
                                    ...
                                    <div class="toolbar clearfix">
                                        ...
                                        <div>
                                            <a href="<?php echo e(route('Login.create')); ?>" class="user-signup-link">
                                                I want to register
...
<?php /**PATH D:\Program Files\xampp\htdocs\Do-An-Laravel\resources\views/Admin/Login/Login-index.blade.php ENDPATH**/ ?>