...
<div class="page-content">
    ...
    <div class="row">
        <div class="col-xs-12">
            ...
            <form class="form-horizontal" role="form" action="<?php echo e(route('DonViVanChuyen.update',$dvvc)); ?>" method="post" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-3">
                        <div class="input-group">
                            ...
                            <input class="form-control" type="text" placeholder="Nhập tên đơn vị vận chuyển" value="<?php echo e($dvvc->TenDonViVanChuyen); ?>" name="TenDonViVanChuyen" />
                        </div>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-3">
                        <div class="input-group">
                            ...
                            <input class="form-control" type="text" placeholder="Nhập website" value="<?php echo e($dvvc->Website); ?>" name="Website" />
                        </div>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-3">
                        ...
                        <input type="text"  id="spinner3" value="<?php echo e($dvvc->Email); ?>" name="Email" />
                        </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-3">
                        <div class="input-group">
                            ...
                            <input type="text"  id="spinner1" value="<?php echo e($dvvc->Phone); ?>" name="Phone" />
                        </div>
                    </div>
...
<?php echo $__env->make('layouts.Layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\tranphuocvinh\laravel\Do-An-Laravel\resources\views/DonViVanChuyen/DonViVanChuyen-edit.blade.php ENDPATH**/ ?>