...
<div class="main-content">
    <div class="breadcrumbs" id="breadcrumbs">
        ...
        <ul class="breadcrumb">
            ...
            <li>
                <a href="<?php echo e(route('CTKhuyenMai.index')); ?>">Chi tiết CT-khuyến mãi</a>
            </li>
    ...
    <div class="page-content">
        <div class="page-header">
            <h1>
                ...
                <small>
                    ...
                    Nhập thông tin để tạo mới Chi tiết ct-khuyến mãi
                </small>
            </h1>
        </div><!-- /.page-header -->
        ...
        <div class="row">
            <div class="col-xs-12">
                <div class="pull">
                    <a type="button" class="btn btn-info " href="<?php echo e(route('CTKhuyenMai.index')); ?>"><i class="fa fa-angle-double-left"></i> Back</a>
                </div>
                <!-- PAGE CONTENT BEGINS -->
                

                <form class="form-horizontal" role="form" action="<?php echo e(route('CTKhuyenMai.store')); ?>" method="post" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-3">
                            <div class="input-group">
                                ...
                                <select class="width-90 chosen-select custom-select" id="form-field-select-3" data-placeholder="" name="ChuongTrinhKhuyenMaiId">
                                    ...
                                    <option value="<?php echo e($item->id); ?>">
                                        <?php echo e($item->TenChuongTrinh); ?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-3">
                            <div class="input-group">
                                ...
                                <select class="width-90 chosen-select custom-select" id="form-field-select-3" data-placeholder="" name="SanPhamId">
                    ...
                    <div class="form-group">
                        <label class="col-sm-1 control-label no-padding-right" for="form-field-1"> Gía giảm </label>
                        ...
                        <div class="col-sm-3">
                            <div class="input-group">
                                ...
                                <input type="text" class="input-mini" id="spinner2" value="" name="GiamGia" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-3">
                            ...
                            <input type="number" class="input-mini" id="spinner3" value="" name="SoLuong" />
                        </div>
                    </div>
                    <div class="space-4"></div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.Layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Program Files\xampp\htdocs\Do-An-Laravel\resources\views/CTKhuyenMai/CTKhuyenMai-create.blade.php ENDPATH**/ ?>