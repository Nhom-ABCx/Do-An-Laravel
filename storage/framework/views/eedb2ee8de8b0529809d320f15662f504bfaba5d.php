                ...
                <div class="col-xs-12">
                    <div class="widget-box">
                        <div class="widget-header">
                            ...
                            <form class="form-inline" action="<?php echo e(request()->is('Admin/BinhLuann/DaXoa') ? route('BinhLuan.DaXoa') : route('BinhLuan.index')); ?>" method="get">

                                <?php if(request()->is('Admin/BinhLuann/DaXoa')): ?>
                                ...
                                <?php $__currentLoopData = $bLuan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td><?php echo e($item->SanPham->TenSanPham); ?>
                                            ...
                                            <img src='/storage/assets/images/product-image/<?php echo e($item->SanPham->HinhAnh); ?>' alt="<?php echo e($item->SanPham->HinhAnh); ?>" width='50' height='50'>
                                        </td>
...
<?php echo $__env->make('Admin.layouts.Layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\tranphuocvinh\laravel\Do-An-Laravel\resources\views/Admin/BinhLuan/binh-luan-index.blade.php ENDPATH**/ ?>