        ...
        <div class="main-container-inner">
            ...
            <div class="sidebar" id="sidebar">
                ...
                <ul class="nav nav-list">
                    ...
                    <li
                        class="<?php echo e(request()->is('Admin/SanPham') || request()->is('Admin/LoaiSanPham') ? 'active open' : ''); ?>">
                    ...
                    <li
                        class="<?php echo e(request()->is('Admin/San_Pham/Sao') || request()->is('Admin/San_Pham/Sao') ? 'active open' : ''); ?>">
                    ...
                    <li
                        class="<?php echo e(request()->is('Admin/KhuyenMai') || request()->is('Admin/CTKhuyenMai') ? 'active open' : ''); ?>">
                        <a href="#" class="dropdown-toggle">
                    ...
                    <li
                        class="<?php echo e(request()->is('Admin/DonViVanChuyen') || request()->is('Admin/NguoiVanChuyen') ? 'active open' : ''); ?>">
                        <a href="#" class="dropdown-toggle">
...
<?php /**PATH D:\Program Files\xampp\htdocs\Do-An-Laravel\resources\views/Admin/layouts/Layout.blade.php ENDPATH**/ ?>