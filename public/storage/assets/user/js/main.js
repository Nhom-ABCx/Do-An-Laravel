$(document).ready(function () {
    ...
    $(".active-banner-slider").owlCarousel({
        ...
        nav: true,
        navText: [
            "<img src='/storage/assets/user/img/banner/prev.png'>",
            "<img src='/storage/assets/user/img/banner/next.png'>",
        ],
        dots: false,
    });
    ...
    $(".active-product-area").owlCarousel({
        ...
        nav: true,
        navText: [
            "<img src='/storage/assets/user/img/product/prev.png'>",
            "<img src='/storage/assets/user/img/product/next.png'>",
        ],
        dots: false,
    });
