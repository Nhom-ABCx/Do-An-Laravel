...
class CreateTrigger extends Migration
{
    ...
    public function up()
    {
        ...
        DB::unprepared('CREATE TRIGGER tao_MaSanPham_CTSanPham_khiUpdate AFTER UPDATE ON `ct_san_pham_values` FOR EACH ROW
                ...
                END');
        DB::unprepared('CREATE TRIGGER tao_MaSanPham_CTSanPham_khiInsert AFTER INSERT ON `ct_san_pham_values` FOR EACH ROW
                BEGIN
                    DECLARE NEWCTSanPhamId INT;
                    SET NEWCTSanPhamId = NEW.CTSanPhamId;
    ...
    public function down()
    {
        ...
        DB::unprepared('DROP TRIGGER `tao_MaSanPham_CTSanPham_khiInsert`');
    }
}
