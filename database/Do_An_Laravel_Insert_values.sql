...
insert into Tai_Khoans(Username,Email,Phone,MatKhau,LoaiTaiKhoanId,created_at) values('Admin','Admin@gmail.com','0779597983','Admin',1,'2021-11-11')					;
insert into Tai_Khoans(Username,Email,Phone,MatKhau,LoaiTaiKhoanId,created_at) values('NhanVien01','NhanVien01@gmail.com','0238506390','passwordNV01',2,'2007-10-13')	;
insert into Tai_Khoans(Username,Email,Phone,MatKhau,LoaiTaiKhoanId,created_at) values('NhanVien02','NhanVien02@gmail.com','0176440449','passwordNV02',2,'1988-08-22')	;
insert into Tai_Khoans(Username,Email,Phone,MatKhau,LoaiTaiKhoanId,created_at) values('NhanVien03','NhanVien03@gmail.com','0300345555','passwordNV03',2,'1987-09-18')	;
insert into Tai_Khoans(Username,Email,Phone,MatKhau,LoaiTaiKhoanId,created_at) values('Khach01','Khach01@gmail.com','0618431768','passwordKH01',3,'1985-03-25')			;
insert into Tai_Khoans(Username,Email,Phone,MatKhau,LoaiTaiKhoanId,created_at) values('Khach02','Khach02@gmail.com','0452803292','passwordKH02',3,'2015-07-09')			;
insert into Tai_Khoans(Username,Email,Phone,MatKhau,LoaiTaiKhoanId,created_at) values('Khach03','Khach03@gmail.com','0566425150','passwordKH03',3,'1991-11-24')			;
insert into Tai_Khoans(Username,Email,Phone,MatKhau,LoaiTaiKhoanId,created_at) values('Khach04','Khach04@gmail.com','0982099712','passwordKH04',3,'2014-10-27')			;
insert into Tai_Khoans(Username,Email,Phone,MatKhau,LoaiTaiKhoanId,created_at) values('Khach05','Khach05@gmail.com','0333641834','passwordKH05',3,'2010-10-26')			;
insert into Tai_Khoans(Username,Email,Phone,MatKhau,LoaiTaiKhoanId,created_at) values('KhachVip01','KhachVip01@gmail.com','0646538241','passwordKHVip01',4,'2015-06-10');
insert into Tai_Khoans(Username,Email,Phone,MatKhau,LoaiTaiKhoanId,created_at) values('KhachVip02','KhachVip02@gmail.com','0607898304','passwordKHVip02',4,'1983-04-16') ;
insert into Tai_Khoans(Username,Email,Phone,MatKhau,LoaiTaiKhoanId,created_at) values('QLKho01','QLKho01@gmail.com','0982108868','passwordQLKho01',5,'2007-10-18')		 ;
insert into Tai_Khoans(Username,Email,Phone,MatKhau,LoaiTaiKhoanId,created_at) values('QLKho02','QLKho02@gmail.com','0848392561','passwordQLKho02',5,'1976-02-01')		 ;
insert into Tai_Khoans(Username,Email,Phone,MatKhau,LoaiTaiKhoanId,created_at) values('QLNhanSu01','QLNhanSu01@gmail.com','0953686248','passwordQLNhanSu01',6,'2009-04-08');

insert into Nhan_Viens(HoTen,NgaySinh,GioiTinh,DiaChi,HinhAnh,TaiKhoanId,created_at,Luong) values (N'Administrator','2007/02/14',1,N'TP HCM',null,1,'1991-11-11',0)							 ;
insert into Nhan_Viens(HoTen,NgaySinh,GioiTinh,DiaChi,HinhAnh,TaiKhoanId,created_at,Luong) values (N'Bà Huyện Thanh Quan','1997/04/14',0,N'O7, Cao Bá Nhạ, Hậu Giang',null,2,'1991-11-11',0);
insert into Nhan_Viens(HoTen,NgaySinh,GioiTinh,DiaChi,HinhAnh,TaiKhoanId,created_at,Luong) values (N'Nguyễn Hữu Cảnh','2002/11/12',0,N'P7, Đồng Khởi, Lào Cai',null,2,'1991-11-11',0)		;
insert into Nhan_Viens(HoTen,NgaySinh,GioiTinh,DiaChi,HinhAnh,TaiKhoanId,created_at,Luong) values (N'Alexandre de Rhodes','2020/08/03',0,N'B0, Lê Lai, Thái Bình',null,2,'1991-11-11',0)	;
insert into Nhan_Viens(HoTen,NgaySinh,GioiTinh,DiaChi,HinhAnh,TaiKhoanId,created_at,Luong) values (N'Nguyễn Du','1976/09/07',1,N'D9, Nguyễn Phi Khanh, Thái Bình',null,5,'1991-11-11',0)	;
insert into Nhan_Viens(HoTen,NgaySinh,GioiTinh,DiaChi,HinhAnh,TaiKhoanId,created_at,Luong) values (N'Cao Thắng','1987/02/02',1,N'O6, Alexandre de Rhodes, Hậu Giang',null,5,'1991-11-11',0)	;
insert into Nhan_Viens(HoTen,NgaySinh,GioiTinh,DiaChi,HinhAnh,TaiKhoanId,created_at,Luong) values (N'Chu Du','1992/12/07',1,N'B3, Trịnh Như Khuê, Hậu Giang',null,6,'1991-11-11',0);

insert into Khach_Hangs(HoTen,NgaySinh,GioiTinh,DiaChi,HinhAnh,TaiKhoanId,created_at) values (N'Hồ Huấn Nghiệp','1990/11/24',0,N'J5, Nguyễn Hữu Cầu, Thanh Hóa',null,3,'1991-11-11');
insert into Khach_Hangs(HoTen,NgaySinh,GioiTinh,DiaChi,HinhAnh,TaiKhoanId,created_at) values (N'Hàm Nghi','1996/10/15',0,N'D4, Huỳnh Khương Ninh, Tiền Giang',null,3,'1991-11-11')	;
insert into Khach_Hangs(HoTen,NgaySinh,GioiTinh,DiaChi,HinhAnh,TaiKhoanId,created_at) values (N'Hồ Tùng Mậu','1986/04/09',0,N'P1, Bùi Viện, Hải Phòng',null,3,'1991-11-11')			;
insert into Khach_Hangs(HoTen,NgaySinh,GioiTinh,DiaChi,HinhAnh,TaiKhoanId,created_at) values (N'Nguyễn Cư Trinh','1994/08/27',1,N'W7, Mai Thị Lựu, Trà Vinh',null,3,'1991-11-11')	;
insert into Khach_Hangs(HoTen,NgaySinh,GioiTinh,DiaChi,HinhAnh,TaiKhoanId,created_at) values (N'Bùi Viện','1990/09/06',1,N'D3, Nam Quốc Cang, Bình Định',null,3,'1991-11-11')		;
insert into Khach_Hangs(HoTen,NgaySinh,GioiTinh,DiaChi,HinhAnh,TaiKhoanId,created_at) values (N'Lý Tự Trọng','1995/01/12',1,N'V6, Chu Mạnh Trinh, Tuyên Quang',null,4,'1991-11-11')	;
insert into Khach_Hangs(HoTen,NgaySinh,GioiTinh,DiaChi,HinhAnh,TaiKhoanId,created_at) values (N'Lý Văn Phức','1987/09/17',0,N'F7, Nguyễn Huệ, Kon Tum',null,4,'1991-11-11')			;
...
insert into San_Phams(TenSanPham,MoTa,SoLuongTon,DonGia,HinhAnh,LuotMua,NhaCungCapId,LoaiSanPhamId,created_at)
...
insert into Chuong_Trinh_Khuyen_Mais(TenChuongTrinh,MoTa,FromDate,ToDate,NhanVienId,created_at) values(N'Khuyến mãi cực hot ngày 20/11',N' giảm giá đến 5000đ các loại phụ kiện','2021-11-20','2021-12-01',1,'2021-10-19');
...
insert into Trang_Thai_HDs(TenTrangThai,MoTa) values(N'ChuaThanhToan','Đơn chưa thanh toán');
insert into Trang_Thai_HDs(TenTrangThai,MoTa) values(N'DaThanhToan','Đơn đã thanh toán')	  ;
insert into Trang_Thai_HDs(TenTrangThai,MoTa) values(N'DaGiao','Đơn đã giao')				  ;
insert into Trang_Thai_HDs(TenTrangThai,MoTa) values(N'DaHuy','Đơn đã được hủy')			  ;
insert into Trang_Thai_HDs(TenTrangThai,MoTa) values(N'DangXuLy','Đơn đang xử lý')		  ;
insert into Trang_Thai_HDs(TenTrangThai,MoTa) values(N'DangVanChuyen','Đơn đang vận chuyển');

insert into Hoa_Dons(NhanVienId,KhachHangId,DiaChiGiao,TrangThaiHDId,NgayGiao,NguoiVanChuyenId,TongTien,created_at) values(1,5,null,4,'2021/03/29',1,0,'2021/01/27');
insert into Hoa_Dons(NhanVienId,KhachHangId,DiaChiGiao,TrangThaiHDId,NgayGiao,NguoiVanChuyenId,TongTien,created_at) values(5,4,null,5,'2021/03/14',2,0,'2021/01/15');
insert into Hoa_Dons(NhanVienId,KhachHangId,DiaChiGiao,TrangThaiHDId,NgayGiao,NguoiVanChuyenId,TongTien,created_at) values(6,5,null,6,'2021/01/13',3,0,'2021/01/11');
insert into Hoa_Dons(NhanVienId,KhachHangId,DiaChiGiao,TrangThaiHDId,NgayGiao,NguoiVanChuyenId,TongTien,created_at) values(6,5,null,3,'2021/03/28',4,0,'2021/03/30');
insert into Hoa_Dons(NhanVienId,KhachHangId,DiaChiGiao,TrangThaiHDId,NgayGiao,NguoiVanChuyenId,TongTien,created_at) values(3,5,null,1,'2021/02/23',5,0,'2021/03/30');
insert into Hoa_Dons(NhanVienId,KhachHangId,DiaChiGiao,TrangThaiHDId,NgayGiao,NguoiVanChuyenId,TongTien,created_at) values(1,7,null,1,'2021/02/27',6,0,'2021/04/29');
insert into Hoa_Dons(NhanVienId,KhachHangId,DiaChiGiao,TrangThaiHDId,NgayGiao,NguoiVanChuyenId,TongTien,created_at) values(4,4,null,5,'2021/03/17',7,0,'2021/04/07');
insert into Hoa_Dons(NhanVienId,KhachHangId,DiaChiGiao,TrangThaiHDId,NgayGiao,NguoiVanChuyenId,TongTien,created_at) values(1,4,null,1,'2021/04/10',1,0,'2021/01/11');
insert into Hoa_Dons(NhanVienId,KhachHangId,DiaChiGiao,TrangThaiHDId,NgayGiao,NguoiVanChuyenId,TongTien,created_at) values(2,3,null,3,'2021/04/20',2,0,'2021/01/29');
insert into Hoa_Dons(NhanVienId,KhachHangId,DiaChiGiao,TrangThaiHDId,NgayGiao,NguoiVanChuyenId,TongTien,created_at) values(4,4,null,4,'2021/03/07',3,0,'2021/04/29');
insert into Hoa_Dons(NhanVienId,KhachHangId,DiaChiGiao,TrangThaiHDId,NgayGiao,NguoiVanChuyenId,TongTien,created_at) values(4,3,null,6,'2021/01/24',4,0,'2021/01/11');
insert into Hoa_Dons(NhanVienId,KhachHangId,DiaChiGiao,TrangThaiHDId,NgayGiao,NguoiVanChuyenId,TongTien,created_at) values(4,4,null,6,'2021/01/23',5,0,'2021/01/29');
insert into Hoa_Dons(NhanVienId,KhachHangId,DiaChiGiao,TrangThaiHDId,NgayGiao,NguoiVanChuyenId,TongTien,created_at) values(1,3,null,4,'2021/02/15',6,0,'2021/01/27');
insert into Hoa_Dons(NhanVienId,KhachHangId,DiaChiGiao,TrangThaiHDId,NgayGiao,NguoiVanChuyenId,TongTien,created_at) values(7,2,null,3,'2021/02/28',7,0,'2021/01/15');
insert into Hoa_Dons(NhanVienId,KhachHangId,DiaChiGiao,TrangThaiHDId,NgayGiao,NguoiVanChuyenId,TongTien,created_at) values(6,2,null,1,'2021/02/18',1,0,'2021/01/15');
insert into Hoa_Dons(NhanVienId,KhachHangId,DiaChiGiao,TrangThaiHDId,NgayGiao,NguoiVanChuyenId,TongTien,created_at) values(4,3,null,4,'2021/02/25',2,0,'2021/03/30');
insert into Hoa_Dons(NhanVienId,KhachHangId,DiaChiGiao,TrangThaiHDId,NgayGiao,NguoiVanChuyenId,TongTien,created_at) values(4,7,null,6,'2021/01/04',3,0,'2021/01/27');
insert into Hoa_Dons(NhanVienId,KhachHangId,DiaChiGiao,TrangThaiHDId,NgayGiao,NguoiVanChuyenId,TongTien,created_at) values(3,6,null,6,'2021/03/28',4,0,'2021/01/29');
insert into Hoa_Dons(NhanVienId,KhachHangId,DiaChiGiao,TrangThaiHDId,NgayGiao,NguoiVanChuyenId,TongTien,created_at) values(4,6,null,6,'2021/02/13',5,0,'2021/01/29');
insert into Hoa_Dons(NhanVienId,KhachHangId,DiaChiGiao,TrangThaiHDId,NgayGiao,NguoiVanChuyenId,TongTien,created_at) values(2,4,null,2,'2021/01/26',6,0,'2021/04/07');
insert into Hoa_Dons(NhanVienId,KhachHangId,DiaChiGiao,TrangThaiHDId,NgayGiao,NguoiVanChuyenId,TongTien,created_at) values(1,7,null,3,'2021/04/24',7,0,'2021/01/29');
insert into Hoa_Dons(NhanVienId,KhachHangId,DiaChiGiao,TrangThaiHDId,NgayGiao,NguoiVanChuyenId,TongTien,created_at) values(4,4,null,1,'2021/01/09',1,0,'2021/04/29');
insert into Hoa_Dons(NhanVienId,KhachHangId,DiaChiGiao,TrangThaiHDId,NgayGiao,NguoiVanChuyenId,TongTien,created_at) values(7,5,null,4,'2021/01/23',2,0,'2021/01/27');
insert into Hoa_Dons(NhanVienId,KhachHangId,DiaChiGiao,TrangThaiHDId,NgayGiao,NguoiVanChuyenId,TongTien,created_at) values(5,4,null,2,'2021/03/04',3,0,'2021/01/27');
insert into Hoa_Dons(NhanVienId,KhachHangId,DiaChiGiao,TrangThaiHDId,NgayGiao,NguoiVanChuyenId,TongTien,created_at) values(7,1,null,2,'2021/04/10',4,0,'2021/04/28');
insert into Hoa_Dons(NhanVienId,KhachHangId,DiaChiGiao,TrangThaiHDId,NgayGiao,NguoiVanChuyenId,TongTien,created_at) values(1,6,null,2,'2021/03/15',5,0,'2021/01/29');
insert into Hoa_Dons(NhanVienId,KhachHangId,DiaChiGiao,TrangThaiHDId,NgayGiao,NguoiVanChuyenId,TongTien,created_at) values(4,5,null,2,'2021/01/31',6,0,'2021/01/29');
insert into Hoa_Dons(NhanVienId,KhachHangId,DiaChiGiao,TrangThaiHDId,NgayGiao,NguoiVanChuyenId,TongTien,created_at) values(3,6,null,3,'2021/01/29',7,0,'2021/01/15');
insert into Hoa_Dons(NhanVienId,KhachHangId,DiaChiGiao,TrangThaiHDId,NgayGiao,NguoiVanChuyenId,TongTien,created_at) values(4,2,null,3,'2021/01/19',1,0,'2021/01/29');
insert into Hoa_Dons(NhanVienId,KhachHangId,DiaChiGiao,TrangThaiHDId,NgayGiao,NguoiVanChuyenId,TongTien,created_at) values(1,7,null,4,'2021/03/14',2,0,'2021/01/15');
